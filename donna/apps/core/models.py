...
class CompanySettings(models.Model):
    ...
    geschaeftsfuehrer = models.CharField(max_length=255, blank=True, verbose_name="Geschäftsführer")
    ...
    bank_name         = models.CharField(max_length=255, blank=True, verbose_name="Bank 1 – Name")
    iban              = models.CharField(max_length=34, blank=True, verbose_name="Bank 1 – IBAN")
    bic               = models.CharField(max_length=11, blank=True, verbose_name="Bank 1 – BIC")
    bank2_name        = models.CharField(max_length=255, blank=True, verbose_name="Bank 2 – Name")
    bank2_iban        = models.CharField(max_length=34, blank=True, verbose_name="Bank 2 – IBAN")
    bank2_bic         = models.CharField(max_length=11, blank=True, verbose_name="Bank 2 – BIC")
